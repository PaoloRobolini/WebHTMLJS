...
var At = (e) => new se(e);
var nt = Symbol.for("atomico.hooks");
globalThis[nt] = globalThis[nt] || {};
var O = globalThis[nt];
var oe = Symbol.for("Atomico.suspense");
var Ft = Symbol.for("Atomico.effect");
var re = Symbol.for("Atomico.layoutEffect");
var Rt = Symbol.for("Atomico.insertionEffect");
var M = (e, t, n) => {
  const { i: s, hooks: r } = O.c, o = r[s] = r[s] || {};
  return o.value = e(o.value), o.effect = t, o.tag = n, O.c.i++, r[s].value;
};
var ae = (e) => M((t = At(e)) => t);
var _ = () => M((e = At(O.c.host)) => e);
var $t = () => O.c.update;
var ce = (e, t, n = 0) => {
  let s = {}, r = false;
  const o = () => r, a = (l, c) => {
...
var { isArray: ie } = Array;
var st = (e, t) => (t ? e instanceof HTMLStyleElement : true) && "hydrate" in (e?.dataset || {});
function Ut(e, t) {
  let n;
  const s = (r) => {
    let { length: o } = r;
...
var Lt = (e, t, n) => (e.addEventListener(t, n), () => e.removeEventListener(t, n));
var _t = class {
  /**
   *
...
var Yt = (e, { type: t, base: n = CustomEvent, ...s }) => e.dispatchEvent(new n(t, s));
var he = (e) => e.replace(/([A-Z])/g, "-$1").toLowerCase();
var me = (e, t, n, s) => s == null || t == Boolean && !s ? e.removeAttribute(n) : e.setAttribute(
  n,
  t?.name === x && t?.serialize ? t?.serialize(s) : R(s) ? JSON.stringify(s) : t == Boolean ? "" : s
);
var ye = (e, t) => e == Boolean ? !!fe[t] : e == Number ? Number(t) : e == String ? t : e == Array || e == Object ? JSON.parse(t) : e.name == x ? t : (
...
var be = (e, t) => e == null || t == null ? { value: t, error: false } : e != String && t === "" ? { value: void 0, error: false } : e == Object || e == Array || e == Symbol ? {
  value: t,
  ...
  class i extends o {
    ...
    async _setup() {
      ...
      this.mounted = new Promise(
        ...
        (y) => this.unmount = () => {
          y(), (c != this.parentNode || !this.isConnected) && (f.cleanEffects(true)()(), d = this.parentNode, c = null);
        }
      ...
      this.update = () => (m || (m = true, this.updated = (this.updated || this.mounted).then(() => {
        try {
          ...
          return y && //@ts-ignore
          y.render(this, this.symbolId, g), m = false, E && !f.isSuspense() && (E = false, !g && Ee(this)), h();
        } finally {
          m = false;
        }
      }).then(
...
function Ee(e) {
  ...
  if (n && t.length) {
    const s = [];
    Ut(t, (r) => {
      r && (r instanceof Element ? n.appendChild(r.cloneNode(true)) : s.push(r));
...
var Bt = (e) => (t, n) => {
  M(
     ...
     */
    ([s, r] = []) => ((r || !r) && (r && It(r, n) ? s = s || true : (T(s) && s(), s = null)), [s, n]),
    /**
     * @returns {any}
     */
    ([s, r], o) => o ? (T(s) && s(), []) : [s || t(), r],
...
var ot = A("atomico/options");
globalThis[ot] = globalThis[ot] || {
  sheet: !!document.adoptedStyleSheets
};
var xt = globalThis[ot];
var Se = {
  checked: 1,
  value: 1,
  selected: 1
...
var q = {};
var rt = [];
var at = class extends Text {
};
var Ce = A("atomico/id");
var $ = A("atomico/type");
var X = A("atomico/ref");
var zt = A("atomico/vnode");
var Pe = () => {
};
function Ne(e, t, n) {
...
var Ht = (e, t, ...n) => {
  ...
  if (o === false && e instanceof Function)
    return e(
      r != rt ? { children: r, ...s } : s
    );
...
function Kt(e, t, n = Ce, s, r) {
  ...
  if (t && t[n] && t[n].vnode == e || e[$] != zt)
    return t;
  (e || !t) && (r = r || e.type == "svg", o = e.type != "host" && (e.raw == 1 ? (t && e.clone ? t[X] : t) != e.type : e.raw == 2 ? !(t instanceof e.type) : t ? t[X] || t.localName != e.type : !t), o && e.type != null && (e.raw == 1 && e.clone ? (s = true, t = e.type.cloneNode(true), t[X] = e.type) : t = e.raw == 1 ? e.type : e.raw == 2 ? new e.type() : r ? document.createElementNS(
  ...
  t.attachShadow({ mode: "open", ...e.shadow }), e.props != f && Me(t, f, e.props, c, r), e.children !== d) {
    ...
    l = Oe(
      ...
      !i && s,
      r && e.type == "foreignObject" ? false : r
    );
  }
...
var Re = Ht("host", { style: "display: contents" });
var G = A("atomico/context");
var $e = (e, t) => {
  const n = _();
  De(
    () => Lt(
...
var p = (e, t, n) => (t == null ? t = { key: n } : t.key = n, Ht(e, t));
var I = p;
var Wt = H`*,*:before,*:after{box-sizing:border-box}button{padding:0;touch-action:manipulation;cursor:pointer;user-select:none}`;
var Jt = H`.vh{position:absolute;transform:scale(0)}`;
function lt() {
...
var Ye = /^(\d{4})-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[0-1])$/;
var Q = (e, t) => e.toString().padStart(t, "0");
var v = class _v {
  constructor(t, n, s) {
...
var W = class _W {
  ...
  add(t) {
    ...
    return n.setUTCMonth(n.getUTCMonth() + s), new _W(n.getUTCFullYear(), n.getUTCMonth() + 1);
  }
  equals(t) {
...
var Pt = (e, t, n) => K(e, t, n) === e;
var Nt = (e) => e.target.matches(":dir(ltr)");
var xe = { month: "long", day: "numeric" };
var ze = { month: "long" };
var He = { weekday: "long" };
var V = { bubbles: true };
...
var Je = j(
  (e) => {
    ...
    return I("host", { shadowDom: true, focus: r, children: [
      p("div", { id: "h", part: "heading", children: s.formatter.format(w(s.yearMonth)) }),
      I("table", { ref: n, "aria-labelledby": "h", part: "table", children: [
        p("thead", { children: p("tr", { part: "tr head", children: s.daysLong.map((o, a) => I(
          "th",
          {
            part: `th day day-${We(t.firstDayOfWeek, a)}`,
            scope: "col",
            children: [
              p("span", { class: "vh", children: o }),
              p("span", { "aria-hidden": "true", children: s.daysVisible[a] })
            ]
          }
        )) }) }),
        p("tbody", { children: s.weeks.map((o, a) => p("tr", { part: "tr week", children: o.map((u, i) => {
          const l = s.getDayProps(u);
          return p("td", { part: "td", children: l && p("button", { ...l, children: u.day }) }, i);
        }) }, a)) })
      ] })
    ] });
  },
...
function kt(e) {
  return p(
    "button",
    {
      ...
      children: p("slot", { name: e.name, children: e.children })
    }
  );
}
function dt(e) {
  const t = w(e.page.start), n = w(e.page.end);
  return I("div", { role: "group", "aria-labelledby": "h", part: "container", children: [
    p("div", { id: "h", class: "vh", "aria-live": "polite", "aria-atomic": "true", children: e.formatVerbose.formatRange(t, n) }),
    I("div", { part: "header", children: [
      p(kt, { name: "previous", onclick: e.previous, children: "Previous" }),
      p("slot", { part: "heading", name: "heading", children: p("div", { "aria-hidden": "true", children: e.format.formatRange(t, n) }) }),
      p(kt, { name: "next", onclick: e.next, children: "Next" })
    ] }),
    p(
      ft,
      {
...
var Ze = { year: "numeric" };
var Xe = { year: "numeric", month: "long" };
function et(e, t) {
  return (t.year - e.year) * 12 + t.month - e.month;
}
var Ot = (e, t) => (e = t === 12 ? new W(e.year, 1) : e, {
  start: e,
...
var Qe = j(
  (e) => {
    ...
    return p("host", { shadowDom: true, focus: o.focus, children: p(
      dt,
      {
        ...e,
        ...o,
...
var Mt = (e, t) => v.compare(e, t) < 0 ? [e, t] : [t, e];
var Ve = j(
  (e) => {
